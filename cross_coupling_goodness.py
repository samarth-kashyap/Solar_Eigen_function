...
for l0 in range(l_min,l_max+1):
    ...
    Z_dpt_large = np.zeros((4,total_m, total_m),dtype='complex128')  #for self-coupling approximation
    mi_beg = 0
    ...
    for munu in range(4):
        ...
        Z_dpt = Z_dpt_large[munu,k:k+2*l0+1,k:k+2*l0+1,]    #Matrixfor carrying out DPT
